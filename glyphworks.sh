...
alias gw-dump-alphabets='gw ./manage.py dumpdata glyphs.Alphabet --all --format yaml --output glyphs/fixtures/alphabets.yaml'
alias gw-load-alphabets='gw ./manage.py loaddata --app glyphs alphabets.yaml'

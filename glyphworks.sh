...
alias gw-dump-maps='gw python ./manage.py dumpdata glyphs.Map --all --format yaml --output glyphs/fixtures/maps.yaml'
alias gw-load-maps='gw python ./manage.py loaddata --app glyphs maps.yaml'

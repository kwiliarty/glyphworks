...
alias gw-migrate='gw ./manage.py migrate'
alias gw-dump-glyphs='gw ./manage.py dumpdata glyphs.Glyph --all --format yaml --output glyphs/fixtures/glyphs.yaml'
alias gw-load-glyphs='gw ./manage.py loaddata --app glyphs glyphs.yaml'
alias gw-sync-glyphs='gw ./manage.py syncdata glyphs/fixtures/glyphs.yaml'
alias gw-dump-mappings='gw ./manage.py dumpdata glyphs.Map --all --format yaml --output glyphs/fixtures/mappings.yaml'
alias gw-load-mappings='gw ./manage.py loaddata --app glyphs mappings.yaml'
alias gw-sync-mappings='gw ./manage.py syncdata glyphs/fixtures/mappings.yaml'
alias gw-dump-replacements='gw ./manage.py dumpdata glyphs.Replacement --all --format yaml --natural-primary --output glyphs/fixtures/replacements.yaml'
alias gw-load-replacements='gw ./manage.py loaddata --app glyphs replacements.yaml'
alias gw-sync-replacements='gw ./manage.py syncdata glyphs/fixtures/replacements.yaml'

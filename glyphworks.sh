...
alias gw-pip-audit='gw pip-audit --ignore-vuln GHSA-2p9h-ccw7-33gf'
...
alias gw-makemigrations='gw ./manage.py makemigrations'
alias gw-showmigrations='gw ./manage.py showmigrations'
alias gw-migrate='gw python ./manage.py migrate'
alias gw-dump-glyphs='gw python ./manage.py dumpdata glyphs.Glyph --all --format yaml --output glyphs/fixtures/glyphs.yaml'
alias gw-load-glyphs='gw python ./manage.py loaddata --app glyphs glyphs.yaml'
alias gw-sync-glyphs='gw python ./manage.py syncdata glyphs/fixtures/glyphs.yaml'
alias gw-dump-mappings='gw python ./manage.py dumpdata glyphs.Map --all --format yaml --output glyphs/fixtures/mappings.yaml'
alias gw-load-mappings='gw python ./manage.py loaddata --app glyphs mappings.yaml'
alias gw-sync-mappings='gw python ./manage.py syncdata glyphs/fixtures/mappings.yaml'
alias gw-dump-replacements='gw python ./manage.py dumpdata glyphs.Replacement --all --format yaml --natural-primary --output glyphs/fixtures/replacements.yaml'
alias gw-load-replacements='gw python ./manage.py loaddata --app glyphs replacements.yaml'
alias gw-sync-replacements='gw python ./manage.py syncdata glyphs/fixtures/replacements.yaml'
